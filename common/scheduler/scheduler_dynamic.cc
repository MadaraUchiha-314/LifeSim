...
#include <iostream>
   ...
   int SchedulerDynamic::num_apps_exited = 0;
#endif
   ...
   , m_in_periodic(false)
{
   ...
   // Registering our own marker
   Sim()->getHooksManager()->registerHook(HookType::HOOK_MAGIC_MARKER,end_of_benchmark_callback,(UInt64)0);
}
